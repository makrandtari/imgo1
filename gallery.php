...
<body>
	...
	<header>
		...
		<div class="menu">
				<a href="index.php">Banner Image</a>
				<a href="gallery.php" class="active">Gallery Image</a>
		</div>
	</header>
	...
	<div class="alert alert-update">
		<div>Hey! New verison of <b>IMGO</b> is ready. For download click here &xrarr;<form method="POST" action="gallery.php" style="display: inline-block;"><a class="alert-btn" href="https://projects.propertypistol.com/imgo/downloads/" target="_blank"> Update Now</a></form></div>
	...
	<div class="alert alert-success">
		<div>Done! Images generated successfully. To view generated images &xrarr;<form method="POST" action="gallery.php" style="display: inline-block;"><button class="alert-btn" name="openFileIMGO"> Open Images Folder</button></form></div>
		<a href="gallery.php" class="alert-close">&#10005;</a>
	</div>
	<script>
    var count = 5; var countdown = setInterval(function(){
      if (count == 0){ clearInterval(countdown); window.open('gallery.php', "_self");}
      count--;
    }, 1000);
  </script>
	<?php }
	...
	<main>
		<div>
			<div class="action-box">
				<h4 class="title">Gallery Image Settings</h4>
